...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: (
      <>
        네. <strong>QR 코드</strong>를 쓰시면 홈페이지가 없어도 됩니다. 챗봇을
        만들면 대시보드에서 QR 이미지를 PNG로 내려받을 수 있고, 그걸 인쇄해
        카운터·테이블·객실에 두시면 손님이 휴대폰으로 찍어 바로 대화를
        시작합니다. 앱 설치도, 회원가입도 필요 없습니다. QR은{" "}
        <strong>무료 플랜부터 모든 플랜에서</strong> 제공됩니다. 홈페이지를
        남이 만들어줘서 코드를 못 고치는 경우에도 같은 방법을 쓰실 수 있습니다.
      </>
    ),
  },
  {
    q: "외국인 손님에게도 답할 수 있나요?",
    a: (
      <>
        GLOBAL 플랜(월 99,000원)에서 <strong>한국어·영어·일본어·중국어</strong>{" "}
        응대를 지원합니다. 방문자가 채팅창에서 언어를 고르면 그 언어로 대화가
        이어지고, 자료를 한국어로만 올리셨어도 답변은 손님의 언어로 나갑니다.
        첫 인사말과 자주 묻는 질문은 미리 번역해 두기 때문에 채팅창을 여는
        순간부터 손님의 언어로 보입니다. QR과 함께 쓰면 호텔·게스트하우스·식당
        같은 곳에서 홈페이지 없이 외국인 응대를 시작할 수 있습니다.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    a: (
      <>
        무료 플랜은 챗봇 1개에 <strong>월 대화 100건</strong>까지이고, 사이트
        임베드와 QR이 그대로 됩니다. 먼저 써보시고 한도가 모자라면 올리시면 됩니다.
        STANDARD(월 19,000원)부터는 <strong>대화 건수 제한이 없고</strong>,
        카카오톡 채널까지 쓰시려면 PREMIUM(월 49,000원), 외국인 손님에게 4개
        국어로 답하려면 GLOBAL(월 99,000원)입니다. 부가세 별도이며,
