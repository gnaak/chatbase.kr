...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body:
      "같은 화면 아래 '봇 응답'에 기본으로 들어있는 텍스트형 응답(\"무엇을 원하는지 잘 모르겠어요\" 등)을 삭제하고, 응답을 '스킬데이터형'으로 새로 추가합니다.\n" +
      "가장 많이 놓치는 단계입니다. 텍스트형인 채로 두면 챗봇이 답을 만들어 보내도 그대로 버려지고, 미리 적힌 기본 문구만 나갑니다.",
  },
  {
    title: "Callback API 켜기 (권장)",
    body:
      "폴백 블록 우측 상단 '⋯' > 'Callback API 설정'에서 활성화합니다. 기본 응답 메시지는 아무 문구나 넣어두시면 됩니다.\n" +
      "카카오는 스킬 응답을 5초 안에 받아야 하는데, 파일 학습을 쓰면 이 시간을 넘겨 답이 끊깁니다. 켜두면 '답변을 준비하고 있어요'가 먼저 나가고 완성된 답이 이어서 도착합니다.",
  },
  {
    title: "채널 연결 후 배포",
    body:
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-start gap-2 px-3 py-2.5 rounded-comfy bg-warning-bg">
        ...
        <p className="text-[12px] text-text-main leading-relaxed">
          ...
          위 6번의 <strong>Callback API</strong>를 꼭 켜주세요. 켜지 않으면 답이
          완성되기 전에 끊겨 "다시 여쭤봐 주세요"만 반복됩니다.
        </p>
      </div>
